...
// Desabilitar modificação dos palpites
    useEffect(()=>{
        ...
        jogos.forEach((jogo)=>{
            if( ano !== 2022 || (mes > jogo.attributes.mes.value || (mes == jogo.attributes.mes.value && (dia > jogo.attributes.dia.value || (dia == jogo.attributes.dia.value && hora >= (jogo.attributes.hora.value)))))){
...
<div className="card flex card-left">
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {20} hora = {13} ano = {2022}>
...
{/* ---------------------------------------------------------------------------------------- */}
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {20} hora = {10} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="jogo flex-between" mes = {11} dia = {21} hora = {13} ano = {2022}>
    <div className="times flex-collumn ">
        <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                <div className="flex">
...
<div className="jogo flex-between" mes = {11} dia = {21} hora = {16} ano = {2022}>
    <div className="times flex-collumn ">
        <div className="flex-between">
                {/* -------------------------------------------------------- */}
                <div className="flex">
...
<div className="card flex card-left">
                        ...
                        <div className="jogo flex-between" mes={11} dia={22} hora={7} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {22} hora = {10} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-right">
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {22} hora = {13} ano = {2022}> 
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {22} hora = {16} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-left">
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {23} hora = {7} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {23} hora = {10} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-right">
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {23} hora = {13} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {23} hora = {16} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-left">
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {24} hora = {7} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {24} hora = {10} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-right">
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {24} hora = {13} ano = {2022}> 
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {24} hora = {16} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-left">
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {25} hora = {7} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {25} hora = {10} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-right">
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {25} hora = {13} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {25} hora = {16} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-left">
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {26} hora = {7} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {26} hora = {10} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-right">
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {26} hora = {13} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {26} hora = {16} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-left">
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {27} hora = {7} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {27} hora = {10} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-right">
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {27} hora = {13} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {27} hora = {16} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-left">
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {28} hora = {7} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {28} hora = {10} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-right">
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {28} hora = {13} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {28} hora = {16} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-left">
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {29} hora = {12} ano = {2022}> 
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-right">
                        ...
                        <div className="jogo flex-between" mes = {11} dia = {29} hora = {16} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-left">
                        ...
                        <div className="jogo flex-between"  mes = {11} dia = {30} hora = {12} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-right">
                        ...
                        <div className="jogo flex-between"  mes = {11} dia = {30} hora = {16} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-left">
                        ...
                        <div className="jogo flex-between" mes = {12} dia = {1} hora = {12} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-right">
                        ...
                        <div className="jogo flex-between" mes = {12} dia = {1} hora = {16} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-left">
                        ...
                        <div className="jogo flex-between" mes = {12} dia = {2} hora = {12} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-right">
                        ...
                        <div className="jogo flex-between" mes = {12} dia = {2} hora = {16} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-left">
                        ...
                        <div className="jogo flex-between" mes = {12} dia = {3} hora = {12} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[96]} ></input>
                                </div>
                                <div className="flex-between">
                                    {/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
                                        ...
                                        {/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[97]} ></input>
                                </div>
                            </div>
                            {/* ---------------------------------------------------------------------------------------- */}
                            <div className="informações flex-collumn">
                                <p className="p4">03/12</p>
                                <p className="p4">12:00</p>
                            </div>  
                            {/* ---------------------------------------------------------------------------------------- */}         
                        </div>

                        <div className="jogo flex-between" mes = {12} dia = {3} hora = {16} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
                                        ...
                                        {/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[98]} ></input>
                                </div>
                                <div className="flex-between">
                                    {/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
                                        ...
                                        {/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[99]} ></input>
                                </div>
                            </div>
                            {/* ---------------------------------------------------------------------------------------- */}
                            <div className="informações flex-collumn">
...
<div className="jogo flex-between" mes = {12} dia = {4} hora = {12} ano = {2022}>
    <div className="times flex-collumn ">
        <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[100]} ></input>
        </div>
        <div className="flex-between">
            {/* ---------------------------------------------------------------------------------------- */}
                <div className="flex">
                ...
                {/* ---------------------------------------------------------------------------------------- */}
                <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[101]} ></input>
        </div>
    </div>
    {/* ---------------------------------------------------------------------------------------- */}
    <div className="informações flex-collumn">
        <p className="p4">04/12</p>
        <p className="p4">12:00</p>
    </div>  
    {/* ---------------------------------------------------------------------------------------- */}         
</div>

<div className="jogo flex-between" mes = {12} dia = {4} hora = {16} ano = {2022}>
    <div className="times flex-collumn ">
        <div className="flex-between">
                {/* -------------------------------------------------------- */}
                <div className="flex">
                ...
                {/* ---------------------------------------------------------------------------------------- */}
                <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[102]} ></input>
        </div>
        <div className="flex-between">
            {/* ---------------------------------------------------------------------------------------- */}
                <div className="flex">
                ...
                {/* ---------------------------------------------------------------------------------------- */}
                <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[103]} ></input>
        </div>
    </div>
    {/* ---------------------------------------------------------------------------------------- */}
    <div className="informações flex-collumn">
...
<div className="card flex card-left">
                        ...
                        <div className="jogo flex-between" mes={12} dia={5} hora={12} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[104]}></input>
                                </div>
                                <div className="flex-between">
                                    {/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
                                        ...
                                        {/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[105]} ></input>
                                </div>
                            </div>
                            {/* ---------------------------------------------------------------------------------------- */}
                            <div className="informações flex-collumn">
                                <p className="p4">05/12</p>
                                <p className="p4">12:00</p>
                            </div>  
                            {/* ---------------------------------------------------------------------------------------- */}         
                        </div>

                        <div className="jogo flex-between" mes = {12} dia = {5} hora = {16} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
                                        ...
                                        {/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[106]} ></input>
                                </div>
                                <div className="flex-between">
                                    {/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
                                        ...
                                        {/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[107]} ></input>
                                </div>
                            </div>
                            {/* ---------------------------------------------------------------------------------------- */}
                            <div className="informações flex-collumn">
...
<div className="card flex card-right">
                        ...
                        <div className="jogo flex-between" mes = {12} dia = {6} hora = {12} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[108]} ></input>
                                </div>
                                <div className="flex-between">
                                    {/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
                                        ...
                                        {/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[109]} ></input>
                                </div>
                            </div>
                            {/* ---------------------------------------------------------------------------------------- */}
                            <div className="informações flex-collumn">
                                <p className="p4">06/12</p>
                                <p className="p4">12:00</p>
                            </div>  
                            {/* ---------------------------------------------------------------------------------------- */}         
                        </div>

                        <div className="jogo flex-between" mes = {12} dia = {6} hora = {16} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
                                        ...
                                        {/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[110]} ></input>
                                </div>
                                <div className="flex-between">
                                    {/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
                                        ...
                                        {/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[111]} ></input>
                                </div>
                            </div>
                            {/* ---------------------------------------------------------------------------------------- */}
                            <div className="informações flex-collumn">
...
<div className="card flex card-left">
                        ...
                        <div className="jogo flex-between" mes = {12} dia = {9} hora = {12} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[112]} ></input>
                                </div>
                                <div className="flex-between">
                                    {/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
                                        ...
                                        {/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[113]} ></input>
                                </div>
                            </div>
                            {/* ---------------------------------------------------------------------------------------- */}
                            <div className="informações flex-collumn">
                        ...
                        <div className="jogo flex-between" mes = {12} dia = {9} hora = {16} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
                                        ...
                                        {/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[114]} ></input>
                                </div>
                                <div className="flex-between">
                                    {/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
                                        ...
                                        {/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[115]} ></input>
                                </div>
                            </div>
                            {/* ---------------------------------------------------------------------------------------- */}
                            <div className="informações flex-collumn">
...
<div className="jogo flex-between" mes = {12} dia = {10} hora = {12} ano = {2022}>
    <div className="times flex-collumn ">
        <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[116]} ></input>
        </div>
        <div className="flex-between">
            {/* ---------------------------------------------------------------------------------------- */}
                <div className="flex">
                ...
                {/* ---------------------------------------------------------------------------------------- */}
                <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[117]} ></input>
        </div>
    </div>
    {/* ---------------------------------------------------------------------------------------- */}
    <div className="informações flex-collumn">
        <p className="p4">10/12</p>
        <p className="p4">12:00</p>
    </div>  
    {/* ---------------------------------------------------------------------------------------- */}         
</div>

<div className="jogo flex-between" mes = {12} dia = {10} hora = {16} ano = {2022}>
    <div className="times flex-collumn ">
        <div className="flex-between">
                {/* -------------------------------------------------------- */}
                <div className="flex">
                ...
                {/* ---------------------------------------------------------------------------------------- */}
                <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[118]} ></input>
        </div>
        <div className="flex-between">
            {/* ---------------------------------------------------------------------------------------- */}
                <div className="flex">
                ...
                {/* ---------------------------------------------------------------------------------------- */}
                <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[119]} ></input>
        </div>
    </div>
    {/* ---------------------------------------------------------------------------------------- */}
    <div className="informações flex-collumn">
...
<div className="card flex card-left">
                        ...
                        <div className="jogo flex-between" mes = {12} dia = {13} hora = {16} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                        ...
                        <div className="jogo flex-between" mes = {12} dia = {14} hora = {16} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
                                        {/* -------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-right">
                        ...
                        <div className="jogo flex-between" mes = {12} dia = {17} hora = {12} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[124]} ></input>
                                </div>
                                <div className="flex-between">
                                    {/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
<div className="card flex card-left">
                        ...
                        <div className="jogo flex-between" mes = {12} dia = {18} hora = {12} ano = {2022}>
                            <div className="times flex-collumn ">
                                <div className="flex-between">
{/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
...
{/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[126]} ></input>
                                </div>
                                <div className="flex-between">
                                    {/* ---------------------------------------------------------------------------------------- */}
                                        <div className="flex">
                                        ...
                                        {/* ---------------------------------------------------------------------------------------- */}
                                        <input type="number" id="gols" name="gols" min="0" max="20" placeholder={userOn.palpites[127]} ></input>
                                </div>
                            </div>
                            {/* ---------------------------------------------------------------------------------------- */}
                            <div className="informações flex-collumn">
                                <p className="p4">18/12</p>
                                <p className="p4">12:00</p>
                            </div>  
                            {/* ---------------------------------------------------------------------------------------- */}         
                        </div>
